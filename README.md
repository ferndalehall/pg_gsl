...
![Alt text](./doc/signal+noise.svg)   ![Alt text](./doc/signal+filtered75.svg)  
...
```
![Alt text](./doc/spectrum.svg) The peak with a period of 10 is clearly visible above the noise.
...
```
![Alt text](./doc/truncatedspectrum75.svg) The higher frequencies have been removed.
...
```
![Alt text](./doc/signal+filtered75.svg)  Shown here in yellow, along with the original signal in red.
