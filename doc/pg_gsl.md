...
![Alt text](./signal+noise.svg)   ![Alt text](./signal+filtered75.svg)  
...
```
![Alt text](./spectrum.svg) The peak with a period of 10 is clearly visible above the noise.
...
```
![Alt text](./truncatedspectrum75.svg) The higher frequencies have been removed.
...
```
![Alt text](./signal+filtered75.svg)  Shown here in yellow, along with the original signal in red.
